...
htmlContent += '    <a href="javascript:updateAnswer(\'Hola y muchas gracias por tu compra. Vas a pasar a retirar tu producto por nuestras oficinas? Estamos de Lunes a Viernes de 11 a 18 en Av. Juan Bautista Alberdi 965 oficina 6, esquina Cachimayo, Caballito. Si va a retirarlo otra persona, por favor indicanos su nombre y documento. O te gustaría que te lo enviemos? Está bien una factura B o necesitás una Factura A? En tal caso pasanos tu CUIT. Por último, querés pasarnos tu dirección de email así podemos tenerte al tanto de nuestras ofertas. Saludos, EXXA STORE.\');">Retira sin foto</a>';
htmlContent += '    <a href="javascript:updateAnswer(\'Hola y muchas gracias por tu compra. Vas a pasar a retirar tu producto por nuestras oficinas? Estamos de Lunes a Viernes de 11 a 18 en Av. Juan Bautista Alberdi 965 oficina 6 (http://www.exxa.com.ar/ml/fotosml/timbre.jpg), esquina Cachimayo, Caballito. Si va a retirarlo otra persona, por favor indicanos su nombre y documento. O te gustaría que te lo enviemos? Está bien una factura B o necesitás una Factura A? En tal caso pasanos tu CUIT. Por último, querés pasarnos tu dirección de email así podemos tenerte al tanto de nuestras ofertas. Saludos, EXXA STORE.\');">Retira con foto</a>';
htmlContent += '    <a href="javascript:updateAnswer(\'Hola y muchas gracias por tu compra. Hoy mismo estaremos llevando tu producto a OCA. Está bien una factura B o necesitás una Factura A? En tal caso pasanos tu CUIT. Por último, querés pasarnos tu dirección de email así podemos tenerte al tanto de nuestras ofertas. Saludos, EXXA STORE.\');">Envio OCA hoy</a>';
htmlContent += '    <a href="javascript:updateAnswer(\'Hola y muchas gracias por tu compra. A la brevedad estaremos llevando tu producto a OCA. Está bien una factura B o necesitás una Factura A? En tal caso pasanos tu CUIT. Por último, querés pasarnos tu dirección de email así podemos tenerte al tanto de nuestras ofertas. Saludos, EXXA STORE.\');">Envio OCA brevedad</a>';
htmlContent += '    <a href="javascript:updateAnswer(\'Te adjuntamos en este email la factura de compra en formato digital la que incluye también la garantía del producto. Cualquier otra cosa que necesites, por favor dejánoslo saber. Saludos, EXXA STORE.\');">Envio Factura</a>';

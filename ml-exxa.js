...
htmlContent += '    <a href="javascript:updateAnswer(\'Hola y muchas gracias por tu compra. Hoy mismo estaremos llevando tu producto a OCA. Te adjunto la factura de tu producto en formato digital junto a la garantía dle mismo. Por último, querés pasarnos tu dirección de email así podemos tenerte al tanto de nuestras ofertas. Saludos, EXXA STORE.\');">Envio OCA hoy</a>';
htmlContent += '    <a href="javascript:updateAnswer(\'Hola y muchas gracias por tu compra. A la brevedad estaremos llevando tu producto a OCA. Te adjunto la factura de tu producto en formato digital junto a la garantía dle mismo. Por último, querés pasarnos tu dirección de email así podemos tenerte al tanto de nuestras ofertas. Saludos, EXXA STORE.\');">Envio OCA brevedad</a>';

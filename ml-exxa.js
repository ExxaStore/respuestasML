...
htmlContent += '    <a href="javascript:updateAnswer(\'Hola y muchas gracias por tu compra. Queríamos consultarte si vas a pasar a retirar tu producto por nuestras oficinas? Estamos de Lunes a Viernes de 11 a 18 en Av. Juan Bautista Alberdi 965 oficina 6, esquina Cachimayo, Caballito. Si va a retirarlo otra persona, por favor indicanos su nombre y documento. O te gustaría que te lo enviemos? Por último, querés pasarnos tu dirección de email así podemos tenerte al tanto de nuestras ofertas. Saludos, EXXA STORE. PD: esta es la foto de nuestro <a href="http://www.exxa.com.ar/ml/fotosml/timbre.jpg">TIMBRE</a>, ya que es algo confuso\');">Retira con foto hl</a>';
htmlContent += '    <a href="javascript:updateAnswer(\'Hola y muchas gracias por tu compra. Queríamos consultarte si vas a pasar a retirar tu producto por nuestras oficinas? Estamos de Lunes a Viernes de 11 a 18 en Av. Juan Bautista Alberdi 965 oficina 6, esquina Cachimayo, Caballito. Si va a retirarlo otra persona, por favor indicanos su nombre y documento. O te gustaría que te lo enviemos por moto o por OCA? Por último, querés pasarnos tu dirección de email así podemos tenerte al tanto de nuestras ofertas. Saludos, EXXA STORE. PD: No está funcionando el portero eléctrico, podrías por favor llamarnos al 4432-1272 o 155-717-0000 cuando estés llegando así bajamos?\');">Retira Timbre Roto</a>';
htmlContent += '    <a href="javascript:updateAnswer(\'Hola y muchas gracias por tu compra. Hoy mismo estaremos llevando tu producto a OCA. Te adjunto la factura de tu producto en formato digital junto a la garantía del mismo. Por último, querés pasarnos tu dirección de email así podemos tenerte al tanto de nuestras ofertas. Saludos, EXXA STORE.\');">Envio OCA hoy CON Factura</a>';
htmlContent += '    <a href="javascript:updateAnswer(\'Hola y muchas gracias por tu compra. A la brevedad estaremos llevando tu producto a OCA. Te adjunto la factura de tu producto en formato digital junto a la garantía del mismo. Por último, querés pasarnos tu dirección de email así podemos tenerte al tanto de nuestras ofertas. Saludos, EXXA STORE.\');">Envio OCA brevedad CON Factura</a>';
htmlContent += '    <a href="javascript:updateAnswer(\'Hola y muchas gracias por tu compra. Hoy mismo estaremos llevando tu producto a OCA. Por último, querés pasarnos tu dirección de email así podemos tenerte al tanto de nuestras ofertas. Saludos, EXXA STORE.\');">Envio OCA hoy SIN Factura</a>';
htmlContent += '    <a href="javascript:updateAnswer(\'Hola y muchas gracias por tu compra. A la brevedad estaremos llevando tu producto a OCA. Por último, querés pasarnos tu dirección de email así podemos tenerte al tanto de nuestras ofertas. Saludos, EXXA STORE.\');">Envio OCA brevedad SIN Factura</a>';
